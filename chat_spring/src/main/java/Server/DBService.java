...
public class DBService {
    ...
    public void addToBlackList(String userNick, String blacklistNick) {
    ...
    public String getIdByNickname(String userNick) {
    ...
    public boolean checkClient(String nickname){
    ...
    public String isInBlacklist(ClientHandler client, String str) {
    ...
    public String getBlackList(String userNick, String bl_nick) {
    ...
    public void regNewClient(String nickname, String login, String password) {
        try {
    ...
    public void logger(String nick, String action) {
        try {
